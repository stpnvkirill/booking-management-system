...
> **Важно:** Данный проект является учебной работой студентов IT-колледжа. Он создан в образовательных целях и не предназначен для коммерческого использования.
